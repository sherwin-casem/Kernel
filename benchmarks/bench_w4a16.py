...
SHAPES = {
    ...
    # subhadipmitra, 2026-07-19: current-generation shapes (all models released within
    # the last two years) so the sweep is not only 2024-era models. The dims are
    # near-identical to the rows above, which is the whole point: the W4A16 win is set
    # by the matrix shape, not by the model's release date.
